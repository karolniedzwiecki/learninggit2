...
import { f as Reporter, d as SchemaValidationError, U as UserError, n as name, v as version, j as bugs } from './core.js';
import 'fs';
import 'ajv';
import 'deepmerge';
...
import { C as CLI, e as eventFormatter } from './cli.js';
...
function handleUnknownError(err) {
    ...
    console.groupEnd();
    const bugUrl = `${bugs.url}?issuable_template=Bug`;
