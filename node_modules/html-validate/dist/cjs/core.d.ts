...
declare class ResolvedConfig {
    ...
    private plugins;
    private rules;
    constructor({ metaTable, plugins, rules }: ResolvedConfigData);
...
export { DOMReadyEvent as $, AttributeData as A, SourceReadyEvent as B, Config as C, DynamicValue as D, EventDump as E, TokenEvent as F, TagStartEvent as G, HtmlValidate as H, TagOpenEvent as I, TagEndEvent as J, TagCloseEvent as K, Location as L, MetaData as M, NodeClosed as N, TagReadyEvent as O, ProcessElementContext as P, ElementReadyEvent as Q, Rule as R, Severity as S, TextNode as T, UserError as U, AttributeEvent as V, WhitespaceEvent as W, ConditionalEvent as X, DirectiveEvent as Y, DoctypeEvent as Z, DOMLoadEvent as _, ConfigData as a, TriggerEventMap as a0, ListenEventMap as a1, Formatter as a2, getFormatter as a3, compatibilityCheck as a4, CompatibilityOptions as a5, TokenType as a6, ConfigError as b, ConfigLoader as c, HtmlElement as d, TokenDump as e, SchemaValidationError as f, MetaElement as g, MetaTable as h, MetaCopyableProperty as i, RuleDocumentation as j, Source as k, Report as l, Reporter as m, Message as n, Result as o, presets as p, TransformContext as q, Transformer as r, TemplateExtractor as s, Plugin as t, Parser as u, ruleExists as v, EventHandler as w, EventCallback as x, Event as y, ConfigReadyEvent as z };
